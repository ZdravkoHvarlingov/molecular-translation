...
from models.visual_transformers.encoder_decoder_visual_transformer import EncoderDecoderVisualTransformer
...
class EncoderDecoderOperator:
    ...
    def _save_model(self, model, num_epochs):
        ...
        torch.save(model_state,f'saved_models/visual_transformer_model_state_epoch_{num_epochs}.pth')
